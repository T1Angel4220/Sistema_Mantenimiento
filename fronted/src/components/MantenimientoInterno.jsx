...
const MantenimientoInterno = () => {
    return (
        <form className="crear-equipos-form">
            ...
            <div className="crear-equipos-form-group">
                <label className="crear-equipos-label">Descripción del Mantenimiento:</label>
            ...
            <button type="submit" className="crear-equipos-submit-btn">Registrar Mantenimiento Interno</button>
        </form>
    );
};

export default MantenimientoInterno;
