...
const MostrarEquipos = () => {
    ...
    const fetchHistorialData = async (equipoId) => {
        try {
          ...
          // Procesar cada mantenimiento para incluir detalles y componentes
          const mantenimientosConComponentes = await Promise.all(
            mantenimientosResponse.data.map(async (mantenimiento) => {
              try {
                ...
                return { ...mantenimiento, componentes: [] }; // Devuelve el mantenimiento sin componentes en caso de error
              }
            })
          );
          ...
          setHistorialData({
            mantenimientos: mantenimientosConComponentes,
            actividades: [],
            componentes: [],
            equipos: [],
          });
        ...
        <ul>
          {selectedMantenimiento.componentes
            ...
            .map((componente, index) => (
                ...
                {componente.descripcion || "Descripción no disponible"}
                </div>
